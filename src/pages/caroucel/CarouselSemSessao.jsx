...
export default function CarouselSemSessao() {
                        ...
                        <div className="inner">
                            ...
                            <div
                                ...
                                <div className="container_eventos_listados_div">
                                    <Link to={"/vendaOnline.com/todosEventos"}>
                            ...
                            <div
                                ...
                                className="item" >
                                <div className="container_eventos_listados_div">
                                    <Link to={"/vendaOnline.com/concerto"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Concerto}></img>
                            ...
                            <div
                                ...
                                <div className="container_eventos_listados_div">
                                    <Link to={"/vendaOnline.com/palestra"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Palestra}></img>
                            ...
                            <div
                                ...
                                className="item" >
                                <div className="container_eventos_listados_div">
                                    <Link to={"/vendaOnline.com/teatro"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Teatro}>
                            ...
                            <div
                                ...
                                className="item" >
                                <div className="container_eventos_listados_div">
                                    <Link to={"/vendaOnline.com/seminario"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Seminario}></img>
