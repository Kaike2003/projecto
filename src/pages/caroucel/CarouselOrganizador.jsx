...
export default function CarouselOrganizador() {
                        ...
                        <div className="inner">
                            ...
                            <div
                                ...
                                <div className="container_eventos_listados_div">
                                    <Link to={"/reservaOnline/dashboard/organizador/paginaPrincipal/todosEventos"}>
                            ...
                            <div
                                ...
                                className="item" >
                                <div className="container_eventos_listados_div">
                                    <Link to={"/reservaOnline/dashboard/organizador/paginaPrincipal/concerto"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Concerto}></img>
                            ...
                            <div
                                ...
                                className="item" >
                                <div className="container_eventos_listados_div">
                                    <Link to={"/reservaOnline/dashboard/organizador/paginaPrincipal/shows"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Festa}></img>
                            ...
                            <div
                                ...
                                <div className="container_eventos_listados_div">
                                    <Link to={"/reservaOnline/dashboard/organizador/paginaPrincipal/palestra"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Palestra}></img>
                            ...
                            <div
                                ...
                                className="item" >
                                <div className="container_eventos_listados_div">
                                    <Link to={"/reservaOnline/dashboard/organizador/paginaPrincipal/teatro"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Teatro}>
                            ...
                            <div
                                ...
                                className="item" >
                                <div className="container_eventos_listados_div">
                                    <Link to={"/reservaOnline/dashboard/organizador/paginaPrincipal/seminario"}>
                                        <div className="link_style">
                                            <img
                                                className="bilhete"
                                                src={Seminario}></img>
