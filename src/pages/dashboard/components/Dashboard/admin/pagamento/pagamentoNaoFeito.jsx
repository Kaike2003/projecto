...
export default function PagamentoNaoFeito() {
    ...
    useEffect(() => {
        async function fetchData() {
            const response = await axios.get('http://localhost:3456/admin/pagamentoEvento');
    ...
    const columns = [
        ...
        {
            title: "IBAN", field: "iban", cellStyle: CellStyle, render: (rowData) => <div style={{ width: "280px", padding: "0", fontSize: CellRender.fontSize }}>{
