...
export default function EstruturaOrador() {
            ...
            <div className="titulo_evento_lista_subEstrutura container" >
                <div className="eventos_lista container">
                    ...
                    <NavLink
                        ...
                        to={urlPrivadaOrganizador + `/evento/listar/${idUtilizador}/editar/${idEvento}/orador/criar`}
                    >
                        <span>Criar</span>
                    ...
                    <NavLink
                        key={Math.random().toString(36).substring(2)}
                        to={urlPrivadaOrganizador + `/evento/listar/${idUtilizador}/editar/${idEvento}/orador/listar`}
                    >
                        <span>Listar</span>
