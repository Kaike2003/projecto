...
export default function ShowsFiltroSemSessao() {
    ...
    const fetchMoreData = () => {
        ...
        setTimeout(async () => {
            ...
            const responseNovosEventos = await axios.get(`http://localhost:3456/participante/showsEventosLimite?limite=${currentePage} `)
            const newDataNovosEventos = responseNovosEventos.data;
            setDataNovosEventos(newDataNovosEventos);
                ...
                <div className="container_conteudo">
                    <div className="conteudo_eventos">
                        <div className="conteudo_eventos_vermais">
                            ...
                            <Link
                                to={url + "/shows"} className="btn">Ver mais</Link>
                        </div>
                    </div>
                </div>
