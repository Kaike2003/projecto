...
export default function TodosEventoSemSessao() {
    ...
    useEffect(() => {
        async function fetchData() {
            const response = await axios.get('http://localhost:3456/participante/todosEventos');
            const newData = response.data;
            setData(newData);

            const responseNovosEventos = await axios.get('http://localhost:3456/participante/todosEventosLimite?limite=8');
