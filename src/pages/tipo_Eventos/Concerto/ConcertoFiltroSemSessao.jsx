...
export default function ConcertoFiltroSemSessao() {
    ...
    const fetchMoreData = () => {
        ...
        setTimeout(async () => {
            ...
            const responseNovosEventos = await axios.get(`http://localhost:3456/participante/concertoEventosLimite?limite=${currentePage} `)
            const newDataNovosEventos = responseNovosEventos.data;
            setDataNovosEventos(newDataNovosEventos);
                ...
                <div className="container_conteudo">
                    <div className="conteudo_eventos">
                        <div className="conteudo_eventos_vermais">
                            <h4 className="pb-3 pt-2 text-dark">Concerto</h4>
                            <Link
                                to={url + "/concerto"} className="btn">Ver mais</Link>
                        </div>
                    </div>
                </div>
