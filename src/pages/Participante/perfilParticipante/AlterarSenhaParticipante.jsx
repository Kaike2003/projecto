...
export default function AlterarSenhaParticipante() {
                    ...
                    onSubmit={async (values) => {
                        ...
                        data.map(item => {
                            if (item.email === nomeUtilizador) {
                                axios.put(`http://localhost:3456/participante/perfil/${item.id}/atualizarPalavraPasse`,
                                    {
                                    ...
                                    Swal.fire({
                                        ...
                                        navigate("/reservaOnline/participante/perfil/informacao")
                                    })
