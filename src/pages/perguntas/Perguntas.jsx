          ...
          <div className="faq-list">
            <ul>
              <li data-aos="fade-up" data-aos-delay="100">
                ...
                <a data-bs-toggle="collapse" className="collapse" data-bs-target="#faq-list-1">Como saber se este site é seguro para fazer compras?     <FiChevronDown className="icon-show"></FiChevronDown>
              ...
              <li data-aos="fade-up" data-aos-delay="400">
                <BsQuestionOctagon className="icon-help"></BsQuestionOctagon> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" className="collapsed">Como pagar uma compra feita na internet?
                  <FiChevronDown className="icon-show"></FiChevronDown>
                  <BsX className="icon-close"></BsX>
                </a>
